<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选课说明" prop="xuankeshuoming">
          <el-input v-model="ruleForm.xuankeshuoming" 
              placeholder="选课说明" clearable  :readonly="ro.xuankeshuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选课说明" prop="xuankeshuoming">
              <el-input v-model="ruleForm.xuankeshuoming" 
                placeholder="选课说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
