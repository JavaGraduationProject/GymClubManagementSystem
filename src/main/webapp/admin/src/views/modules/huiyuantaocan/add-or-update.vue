    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="套餐功能" prop="taocangongneng">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.taocangongneng" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.taocangongneng" label="套餐功能" prop="taocangongneng">
                    <span v-html="ruleForm.taocangongneng"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxiaoqi = true;
          ...
          if(o=='taocangongneng'){
            this.ruleForm.taocangongneng = obj[o];
	    this.ro.taocangongneng = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.taocangongneng = this.ruleForm.taocangongneng.replace(reg,'../../../ssmzbr14/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `huiyuantaocan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.huiyuantaocanCrossAddOrUpdateFlag = false;
						 this.parent.search();
