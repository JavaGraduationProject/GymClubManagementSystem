<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="功能" prop="gongneng">
          <el-input v-model="ruleForm.gongneng" 
              placeholder="功能" clearable  :readonly="ro.gongneng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="功能" prop="gongneng">
              <el-input v-model="ruleForm.gongneng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租赁时价" prop="zulinshijia">
          <el-input v-model="ruleForm.zulinshijia" 
              placeholder="租赁时价" clearable  :readonly="ro.zulinshijia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租赁时价" prop="zulinshijia">
              <el-input v-model="ruleForm.zulinshijia" 
                placeholder="租赁时价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.qicaitupian" label="器材图片" prop="qicaitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qicaitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="使用方法" prop="shiyongfangfa">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongfangfa" label="使用方法" prop="shiyongfangfa">
                    <span v-html="ruleForm.shiyongfangfa"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongneng = true;
          ...
          if(o=='zulinshijia'){
            this.ruleForm.zulinshijia = obj[o];
	    this.ro.zulinshijia = true;
            continue;
          }
          if(o=='shiyongfangfa'){
	...
	this.ruleForm.shiyongfangfa = this.ruleForm.shiyongfangfa.replace(reg,'../../../ssmzbr14/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
