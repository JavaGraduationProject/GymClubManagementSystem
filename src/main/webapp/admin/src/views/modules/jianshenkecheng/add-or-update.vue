<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健身效果" prop="jianshenxiaoguo">
          <el-input v-model="ruleForm.jianshenxiaoguo" 
              placeholder="健身效果" clearable  :readonly="ro.jianshenxiaoguo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="健身效果" prop="jianshenxiaoguo">
              <el-input v-model="ruleForm.jianshenxiaoguo" 
                placeholder="健身效果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../ssmzbr14/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
